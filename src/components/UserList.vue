    ...
    <el-row  v-for="index in Math.ceil(users.length/2)" style="height: 110px;">
      <el-col :span="11" style="margin-top: 10px">
        <el-card shadow="hover" @click.native="toProfile(users[index*2-2].id)">
          <el-row>
            <el-col :span="6">
              <el-avatar class="user-avatar" :src="users[index*2-2].avatar"
              fit="cover"
              />
            </el-col>
            <el-col :span="18">
      ...
      <el-col :span="11" v-if="index*2-1< users.length" style="margin-left: 20px; margin-top: 10px">
        <el-card shadow="hover"  @click.native="toProfile(users[index*2-1].id)">
          <el-row>
            <el-col :span="6">
              <el-avatar class="user-avatar" :src="users[index*2-1].avatar"
                        fit="cover"
              />
            </el-col>
            <el-col :span="18">
