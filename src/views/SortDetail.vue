    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <el-row style="align-items: flex-end;">
          <el-col :span="5">
            <el-image :src="sort.cover" fit="cover" style="width: 150px;height: 150px; border: none; box-shadow: none;"/>
          </el-col>
          <el-col :span="10" style="text-align: left;margin-top: 50px">
            <el-row><h1>{{sort.title}}</h1></el-row>
            <el-row style="font-weight: lighter;color: #8c939d"> <span>创建于&nbsp;</span>{{new Date(sort.createTime).toLocaleDateString()}}</el-row>
          </el-col>
          <el-col :span="8" style="margin-top: 124px;text-align: right" v-if="userId==sort.owner">
...
import {getDetail,deleteSort,updateSort} from "@/api/Sort";
